...
# install extension 
ADD packages/cubejs-docker/duckdb_extension/httpfs.duckdb_extension_v1_2_1 /root/.duckdb/extensions/v1.2.1/linux_amd64/httpfs.duckdb_extension
ENV DEV_BUILD_TAG=202504221956-dev
